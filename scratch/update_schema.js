...
async function updateSchema() {
    try {
        ...
        console.log('DB Config:', { host: process.env.DB_HOST, user: process.env.DB_USER, name: process.env.DB_NAME });
        ...
        const alterIncidents = [
            ...
            "ALTER TABLE incidents MODIFY kejadian_serupa BOOLEAN DEFAULT 0",
